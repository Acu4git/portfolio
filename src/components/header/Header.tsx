...
const Header = () => {
  return (
    <header className="w-full h-20 p-4 sticky top-0 bg-slate-700 flex items-center justify-between opacity-80">
      <NavigationMenu>
        <NavigationMenuLink href="/secret" className="hover:opacity-70">
